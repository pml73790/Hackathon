...
export default function LoginForm() {
  ...
  return (
    ...
    >
      <img src="/LoginPortal.jpeg" alt="Login Portal" className="w-full h-auto mx-auto mb-4" />

      <div className="shadow-lg p-5 rounded-lg border-t-4 border-blue-400 bg-white bg-opacity-80">
